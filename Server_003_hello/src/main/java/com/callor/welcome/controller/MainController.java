 ...
 * Class 이름은 특별히 중요ㅔ하지 않다.
 */
// WebServlet Annotation
// 지금부터 이 클래스로 생성된 객체는 Web Service에서 Request를 처리할 객체이다
...
// Tomcat에 의해서 관리되고
// 사용자의 Request에 따라 Tomcat이 클래스의 method를 호출하고 기능을 수행한다
...
// 		/welcome 부분을 분석하여 Run As Server 로 시작된 프로젝트 중에서
// 		root Context가 welcome 인 프로젝트를 찾는다
// 3. 프로젝트가 있으면 /home 문자열을 다시 분석하여
// 		프로젝트 내의 클래스 중에서 @WebServlet("/home") Annotation으로 설정된 클래스를 찾는다
