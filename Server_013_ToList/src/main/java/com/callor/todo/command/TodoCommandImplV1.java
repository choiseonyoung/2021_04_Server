...
public class TodoCommandImplV1 implements TodoCommand {
	...
	public void excute(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		// 		각 컬럼의 Data Type이 문자열, 숫자 등 다양한 Type으로 구성되어 있기 때문에
		...
		// 생성된 form을 사용하여 날짜, 시각 데이터를 문자열로 변환하여 변수에 저장
		...
		// insert로부터 전달받은 숫자
		// 1이상이면 정상 insert이고 그렇지 않으면 추가가 잘못된 것
		Integer ret = toService.insert(tdVO);
		if(ret < 1) {
