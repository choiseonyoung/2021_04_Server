...
/*
 * 싱글톤 패턴
 * 자원 (Resource: 하드웨어장치, 네트워크, 파일..)을 코드에서 활용할 때는
 * 최소한의 연결을 하여 사용하는 것이 여러모로 좋다
 * 
 * 필요한 연결객체를 프로젝트에서 1개만 선언하고 공용으로 사용하는 방법
 * (그래서 dbConn이라는 커넥션을 static으로 만들어놓고
 */
public class DBContract {
	...
	// private static 으로 선언된 변수, 객체를 다른 곳에서 사용할 수 있도록 제공하는 method
	public static Connection getDbConn() {
		return dbConn;
	}
	// 제너레이션 게터세터 들어가서 만들 수도 있음
